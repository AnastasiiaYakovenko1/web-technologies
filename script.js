document.addEventListener('DOMContentLoaded', function () {
    ...
    const citiesByCountry = {
        'Ukraine': ['Чернівці', 'Заставна', 'Глибока', 'Великий Кучурів', 'Стара Вижва'],
    ...
    function validateRegisterField(field) {
        ...
        } else if (field.id === 'acceptTerms') {
            if (!field.checked) {
                isValid = false;
                errorMessage = 'Від умов не втечеш братику';
            }
        }
        ...
        if (field.type !== 'radio') {
            ...
            if (!hasChecked) {
                isValid = false;
                errorMessage = 'Будь ласка, оберіть стать';
            }
